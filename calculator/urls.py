...
urlpatterns = [
    ...
    path('differential-operators', views.differential_operators, name='differential_operators_no_slash'),
    path('api/differential-operators/', views.differential_operators, name='api_differential_operators'),
    path('api/differential-operators', views.differential_operators, name='api_differential_operators_no_slash'),
